...
const root=path.dirname(fileURLToPath(import.meta.url)),port=3237,types={'.html':'text/html; charset=utf-8','.css':'text/css; charset=utf-8','.js':'text/javascript; charset=utf-8'};
...
server.listen(port,'127.0.0.1',()=>console.log(`Agent leave local review: http://127.0.0.1:${port}/`));
