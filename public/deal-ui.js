function dealWorkspaceHTML({deals=[],bookings=[],writable}){
  ...
  return `<div class="comments deal-workspace" data-flow-pane="deal" data-deal-id="${esc(deal.id)}">
    ...
    <section><h4>Transaction parties</h4>${partyRows||'<div class="empty compact">No parties recorded.</div>'}
      ${writable?`<details class="opportunity-inline-form"><summary>Add a required transaction party</summary><form id="deal-party-form" class="form-grid">
