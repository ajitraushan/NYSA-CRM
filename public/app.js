...
async function renderAdmin() {
  ...
  $('#organization-reset').addEventListener('click',()=>resetOrganizationForm());
...
function resetOrganizationForm(){fillOrganizationForm(organizationVersions.find(x=>x.status==='active')||{});}
