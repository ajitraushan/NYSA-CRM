# Release 2.5 dev.47 — Full remediation acceptance
...
| R2.5-REG-CACHE-014 | Browser assets carry the dev.47 cache identity | Cache regression contract | PASS |
...
Deployment target: `2.0.0-dev.47`, migrations `051_release2_final_uat_remediation.sql` and `052_release2_full_remediation_foundation.sql`.
