...
test('booklet proposal generator renders governed customer, property and timeline pages',()=>{
  ...
  const image=png(40,24,[177,139,61]),pdf=makeProposalPdf({proposal:{title:'Aisha Dubai shortlist'},version:1,organization:{displayName:'NYSA Realty',defaultCurrency:'AED',proposalFooter:'NYSA Realty | Private customer proposal'},recipient:{fullName:'Aisha Rahman',postalAddress:'Palm Jumeirah, Dubai, UAE',phone:'+971 50 123 4567',idDocumentType:'emirates_id',idDocumentLast4:'4821'},requirement:{businessLine:'Sale',purpose:'own_use',areas:['Dubai Marina','Palm Jumeirah'],propertyTypes:['Apartment'],bedroomsMin:2,budgetMin:2000000,budgetMax:2500000,fundingMethod:'mortgage',timelineCode:'6-12 months'},properties:[{id:'listing-1',project:'Marina View Residence',inventoryReference:'NYSA-INV-000241',area:'Dubai Marina',propertyType:'Apartment',bedrooms:'2',sizeSqft:1245,developer:'Sample Developer',price:2350000,currency:'AED',handoverDate:'Ready',availabilityConfirmedAt:'2026-07-18'},{id:'listing-2',project:'Palm Garden Residence',inventoryReference:'NYSA-INV-000242',area:'Palm Jumeirah',propertyType:'Apartment',bedrooms:'2',sizeSqft:1380,developer:'Sample Developer',price:2450000,currency:'AED',handoverDate:'Ready',availabilityConfirmedAt:'2026-07-18'},{id:'listing-3',project:'Harbour View Residence',inventoryReference:'NYSA-INV-000243',area:'Dubai Marina',propertyType:'Apartment',bedrooms:'3',sizeSqft:1520,developer:'Sample Developer',price:2500000,currency:'AED',handoverDate:'Ready',availabilityConfirmedAt:'2026-07-18'}],media:[{id:'media-1',listingId:'listing-1',mediaType:'image/png',buffer:image,caption:'Marina view'}],narrative:{highlights:'Marina view, established community and practical layout.',suitability:'Preferred location, layout and budget.',assumptions:'Availability and bank valuation remain subject to confirmation.',indicativeTimeline:{stages:[{label:'Confirm requirements and shortlist',guidance:'Typically 1-2 business days.'},{label:'Viewing and selection',guidance:'Subject to access and buyer availability.'},{label:'Finance and valuation',guidance:'Lender timing applies.'},{label:'Agreement and due diligence',guidance:'Subject to documents.'},{label:'Transfer and handover',guidance:'Scheduled after approvals are complete.'}]}},disclaimer:'Sample information only. Availability, pricing and transaction timing must be reconfirmed.',logo:{buffer:image,mediaType:'image/png'},agent:{name:'Sunita Sinha'},preparedAt:'18 Jul 2026'});
  assert.equal(pdf.subarray(0,8).toString(),'%PDF-1.4');assert.match(pdf.toString('latin1'),/\/Count 4/);assert.match(pdf.toString('latin1'),/YOUR DUBAI PROPERTY SHORTLIST/);assert.match(pdf.toString('latin1'),/AED 2m - AED 2\.5m/);assert.match(pdf.toString('latin1'),/NYSA-INV-000243/);assert.match(pdf.toString('latin1'),/INDICATIVE PURCHASE JOURNEY/);assert.ok(pdf.length>5000);
